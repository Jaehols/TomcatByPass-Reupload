...
<div class="centered_content_container">
    ...
    <c:forEach items="${fixedOrders}" var="forder">
        ...
        <a href="../../orders/edit-fixed-price-order?orderId=${forder.orderId}&sg=false" class="button">Edit this order</a> <br/><br/>
    </c:forEach>
    ...
    <c:forEach items="${auctionOrders}" var="aorder">
        ...
        <a href="../../orders/edit-auction-order?orderId=${aorder.orderId}&sg=false" class="button">Edit this order</a> <br/><br/>
    </c:forEach>
</div>
