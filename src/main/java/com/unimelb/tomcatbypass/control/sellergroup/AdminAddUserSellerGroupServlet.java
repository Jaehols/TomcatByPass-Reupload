...
@WebServlet(name = "AdminAddUserSellerGroupServlet", value = "/auth/admin/sellergroup/seller-group-add-users")
public class AdminAddUserSellerGroupServlet extends HttpServlet {
    private static final Logger log = Logger.getLogger(AdminAddUserSellerGroupServlet.class.getName());
