...
@WebServlet(name = "AdminAllSellerGroupsServlet", value = "/auth/admin/sellergroup/seller-group-home")
public class AdminAllSellerGroupsServlet extends HttpServlet {
    private static final Logger log = Logger.getLogger(AdminAllSellerGroupsServlet.class.getName());
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        List<SellerGroup> sellerGroups = SellerGroupService.findAllSellerGroups();
