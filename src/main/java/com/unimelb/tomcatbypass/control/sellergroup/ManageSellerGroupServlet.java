...
@WebServlet(name = "ManageSellerGroupServlet", value = "/auth/sellergroup/seller-group-manage")
public class ManageSellerGroupServlet extends HttpServlet {
    private static final Logger log = Logger.getLogger(ManageSellerGroupServlet.class.getName());
